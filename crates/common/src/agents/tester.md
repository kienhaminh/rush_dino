...
- Design practical test strategies (unit, integration, e2e)
- Create clear test cases with expected outcomes
- Identify edge cases, failure modes, and risk hotspots
- Improve test coverage where it matters most
- Validate fixes and guard against regressions
