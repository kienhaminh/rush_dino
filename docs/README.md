...
1. **[Vision](../VISION.md)** — Product direction, core principles, and what belongs in RushDino
2. **[Security](../SECURITY.md)** — Operator-controlled safety, memory protection, and runtime boundaries
3. **[Architecture](../ARCHITECTURE.md)** — High-level product architecture for the persistent agent team model
4. **[Project Overview & PDR](./project-overview-pdr.md)** — Vision, requirements, and strategic decisions
5. **[System Architecture](./system-architecture.md)** — Technical deep-dive into gateway, adapters, and message flow
6. **[Project Roadmap](./project-roadmap.md)** — Phases, milestones, and future direction
...
OpenClaw-style operating docs for autonomous diagnosis and safe system modification:

1. **[Architecture Entry](./references/architecture/index.md)** — Scope, capability labels, and operating boundaries
2. **[Tool Catalog](./references/architecture/tools/tool-catalog.md)** — Registered tools and runtime availability
3. **[CRUD Capability Matrix](./references/architecture/reference/crud-capability-matrix.md)** — Canonical C/R/U/D support by resource class
4. **[Troubleshooting Hub](./references/architecture/help/troubleshooting.md)** — Symptom-first runbooks
5. **[First-Class CRUD Gaps](./references/architecture/gaps/first-class-crud-gaps.md)** — Prioritized missing native operations
