...
import { refreshChatAvatar } from './chat.ts';
import { renderUsageTab } from './render-usage-tab.ts';
import { renderChatControls, renderTab, renderThemeToggle } from './render.helpers.ts';

import type { AppViewState } from './view-state.ts';
      ...
      <main class="content ${isChat ? 'content--chat' : ''}">
        ${availableUpdate
          ? html`<div class="update-banner callout danger" role="alert">
              ...
              v${availableUpdate.latestVersion} (running v${availableUpdate.currentVersion}).
              <button
