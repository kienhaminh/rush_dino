...
import { formatRelativeTimestamp, formatMs } from "../components/common/format.ts";

import { pathForTab } from "../components/layout/navigation.ts";

import { formatCronSchedule, formatNextRun } from "../components/common/presenter.ts";
...
import type { CronFormState } from "../components/common/ui-types.ts";
...
const RUN_DELIVERY_OPTIONS: Array<{
  value: CronDeliveryStatus;
  label: string;
}> = [
...
export function renderCron(props: CronProps) {
  ...
  const selectedJob =
    props.runsJobId == null
      ? undefined
      : props.jobs.find((job) => job.id === props.runsJobId);
  ...
  const statusSummary = summarizeSelection(
    selectedStatusLabels,
    "All statuses",
  );
  const deliverySummary = summarizeSelection(
    selectedDeliveryLabels,
    "All delivery",
  );
  ...
  return html`
    <section class="card cron-summary-strip">
      <div class="cron-summary-strip__left">
        <div class="cron-summary-item">
          ...
          <div class="cron-summary-value">
            <span
              class=${`chip ${props.status?.enabled ? "chip-ok" : "chip-danger"}`}
            >
      ...
      <div class="cron-summary-strip__actions">
        ...
        ${props.error
          ? html`<span class="muted">${props.error}</span>`
          : nothing}
      </div>
    </section>
    ...
    <section class="cron-workspace">
          ...
          <div class="filters" style="margin-top: 12px;">
            ...
            <label class="field">
              ...
              <select
                ...
                @change=${(e: Event) =>
                  props.onJobsFiltersChange({
                    cronJobsSortBy: (e.target as HTMLSelectElement)
                      .value as CronJobsSortBy,
                  })}
              >
            ...
            <label class="field">
              ...
              <select
                ...
                @change=${(e: Event) =>
                  props.onJobsFiltersChange({
                    cronJobsSortDir: (e.target as HTMLSelectElement)
                      .value as CronSortDir,
                  })}
              >
            ...
            <div class="cron-run-filters__row cron-run-filters__row--primary">
                ...
                <select
                  ...
                  @change=${(e: Event) =>
                    props.onRunsFiltersChange({
                      cronRunsScope: (e.target as HTMLSelectElement)
                        .value as CronRunScope,
                    })}
                >
              ...
              <label class="field">
                ...
                <select
                  ...
                  @change=${(e: Event) =>
                    props.onRunsFiltersChange({
                      cronRunsSortDir: (e.target as HTMLSelectElement)
                        .value as CronSortDir,
                    })}
                >
      ...
      <section class="card cron-workspace-form">
        ...
        <div class="card-sub">
          ${isEditing
            ? "Update the selected scheduled job."
        ...
        <div class="cron-form">
          ...
          <section class="cron-form-section">
            ...
            <div class="cron-form-section__sub">
          ...
          <section class="cron-form-section">
            ...
            <div class="form-grid cron-form-grid">
              <label class="field">
                ...
                <div class="cron-help">
                  Main posts a system event. Isolated runs a dedicated agent
                  turn.
                </div>
              </label>
              <label class="field">
                ...
                <div class="cron-help">
                  Now triggers immediately. Next heartbeat waits for the next
                  cycle.
                </div>
              </label>
                ...
                ? html`
                    <label class="field">
                      ...
                      <input
                        ...
                        aria-invalid=${props.fieldErrors.timeoutSeconds
                          ? "true"
                          : "false"}
                        aria-describedby=${ifDefined(
                        ...
                        @input=${(e: Event) =>
                          props.onFormChange({
                            timeoutSeconds: (e.target as HTMLInputElement)
                              .value,
                          })}
                      />
                      <div class="cron-help">
                        Optional. Leave blank to use the gateway default timeout
          ...
          <section class="cron-form-section">
            ...
            <div class="form-grid cron-form-grid">
              <label
                class="field ${selectedDeliveryMode === "none"
                  ? "cron-span-2"
                  : ""}"
              >
                ...
                <div class="cron-help">
                  Announce posts a summary to chat. None keeps execution
                  internal.
                </div>
              </label>
              ${selectedDeliveryMode !== "none"
                ? html`
                    <label
                      class="field ${selectedDeliveryMode === "webhook"
                        ? "cron-span-2"
                        : ""}"
                    >
                      ${renderFieldLabel(
                      ...
                      ${selectedDeliveryMode === "webhook"
                        ? html`
                            <input
                              ...
                              aria-invalid=${props.fieldErrors.deliveryTo
                                ? "true"
                                : "false"}
                              aria-describedby=${ifDefined(
                              ...
                              @input=${(e: Event) =>
                                props.onFormChange({
                                  deliveryTo: (e.target as HTMLInputElement)
                                    .value,
                                })}
                      ...
                      ${selectedDeliveryMode === "announce"
                        ? html`
                            <div class="cron-help">
                              Choose which connected channel receives the
                              summary.
                            </div>
                          `
                        : html`
                            <div class="cron-help">
                              Send run summaries to a webhook endpoint.
                            </div>
                          `}
                    </label>
                    ${selectedDeliveryMode === "announce"
                      ? html`
                          <label class="field cron-span-2">
                            ...
                            />
                            <div class="cron-help">
                              Optional recipient override (chat id, phone, or
                              user id).
                            </div>
                          </label>
                        `
          ...
          <details class="cron-advanced">
            ...
            <div class="cron-help">
              Optional overrides for delivery guarantees, schedule jitter, and
              model controls.
            </div>
            <div class="form-grid cron-form-grid">
              ...
              <label class="field checkbox cron-checkbox">
                ...
                <div class="cron-help">
                  Force this job to use the gateway default assistant.
                </div>
              </label>
              ${isCronSchedule
                ? html`
                    <label class="field checkbox cron-checkbox cron-span-2">
                      <input
                        ...
                        @change=${(e: Event) =>
                          props.onFormChange({
                            scheduleExact: (e.target as HTMLInputElement)
                              .checked,
                          })}
                      />
                      <span class="field-checkbox__label"
                        >Exact timing (no stagger)</span
                      >
                      <div class="cron-help">
                        Run on exact cron boundaries with no spread.
                      </div>
                    </label>
                    <div class="cron-stagger-group cron-span-2">
                      <label class="field">
                        ...
                        <input
                          ...
                          aria-invalid=${props.fieldErrors.staggerAmount
                            ? "true"
                            : "false"}
                          aria-describedby=${ifDefined(
                          ...
                          @input=${(e: Event) =>
                            props.onFormChange({
                              staggerAmount: (e.target as HTMLInputElement)
                                .value,
                            })}
                          placeholder="30"
                        />
              ...
              ${isAgentTurn
                ? html`
                    <label class="field">
                      ...
                      />
                      <div class="cron-help">
                        Start typing to pick a known model, or enter a custom
                        one.
                      </div>
                    </label>
                    <label class="field">
                      ...
                      <input
                        ...
                        @input=${(e: Event) =>
                          props.onFormChange({
                            payloadThinking: (e.target as HTMLInputElement)
                              .value,
                          })}
                        placeholder="low"
                      />
                      <div class="cron-help">
                        Use a suggested level or enter a provider-specific
                        value.
                      </div>
                    </label>
                  `
                ...
                ? html`
                    <label class="field checkbox cron-checkbox cron-span-2">
                      <input
                        ...
                        @change=${(e: Event) =>
                          props.onFormChange({
                            deliveryBestEffort: (e.target as HTMLInputElement)
                              .checked,
                          })}
                      />
                      <span class="field-checkbox__label"
                        >Best effort delivery</span
                      >
                      <div class="cron-help">
                        Do not fail the job if delivery itself fails.
                      </div>
                    </label>
                  `
                : nothing}
...
function renderScheduleFields(props: CronProps) {
  ...
  return html`
    <div class="form-grid cron-form-grid" style="margin-top: 12px;">
      ...
      <div class="cron-help cron-span-2">
...
function renderFieldError(message?: string, id?: string) {
  ...
  return html`<div id=${ifDefined(id)} class="cron-help cron-error">
    ${message}
  </div>`;
}
    ...
    <div class="list-item cron-run-entry">
      <div class="list-main cron-run-entry__main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          ...
          ${entry.model
            ? html`<span class="chip">${entry.model}</span>`
            : nothing}
          ${entry.provider
            ? html`<span class="chip">${entry.provider}</span>`
            : nothing}
          ${usageSummary
            ? html`<span class="chip">${usageSummary}</span>`
            : nothing}
        </div>
      </div>
      <div class="list-meta cron-run-entry__meta">
        ...
        ${typeof entry.runAtMs === "number"
          ? html`<div class="muted">Run at ${formatMs(entry.runAtMs)}</div>`
          : nothing}
        ...
        ${entry.deliveryError
          ? html`<div class="muted">${entry.deliveryError}</div>`
          : nothing}
      </div>
    </div>
  `;
