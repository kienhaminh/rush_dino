...
import { formatPresenceAge, formatPresenceSummary } from "../components/common/presenter.ts";

import type { PresenceEntry } from "../components/common/types.ts";
    ...
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="chip-row">
          ...
          ${scopesLabel
            ? html`<span class="chip">${scopesLabel}</span>`
            : nothing}
          ${entry.platform
            ? html`<span class="chip">${entry.platform}</span>`
            : nothing}
          ${entry.deviceFamily
          ...
          ${entry.modelIdentifier
            ...
            : nothing}
          ${entry.version
            ? html`<span class="chip">${entry.version}</span>`
            : nothing}
        </div>
      </div>
      <div class="list-meta">
