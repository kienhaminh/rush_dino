  ...
  return (
    <div className="flex flex-col border-b border-border bg-card">
      ...
      <div className="flex flex-wrap items-center gap-3 px-4 py-2.5 border-b border-border/50">
        ...
        {/* Timezone */}
        <Select value={timeZone} onValueChange={(val) => onTimeZoneChange(val as TimeZone)}>
          <SelectTrigger className="h-8 px-2 text-xs bg-background border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-ring text-foreground w-[100px]">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="local">Local TZ</SelectItem>
